...
class PadMultiViewImageSame2Max(object):
    ...
    def _pad_img(self, results):
        ...
        padded_img = [mmcv.impad(img, shape=(max_h*2, max_w*2), pad_val=self.pad_val) for img in results['front_img']]
    ...
    def __call__(self, results):
        ...
        Returns:
            dict: Normalized results, 'img_norm_cfg' key is added into
                result dict.
        """
        results['front_img'] = [mmcv.imnormalize(img, self.mean, self.std, self.to_rgb) for img in results['front_img']]
...
class RandomScaleImageMultiViewImage(object):
    ...
    def __call__(self, results):
        ...
        results['front_img'] = [results['img'][0].copy()]
