...
bundle_cfg = dict(
    ...
    in_channels=64,
    center_tau=8.0,
    target_smooth_kernel=3,
    inject_iters=[0],
    frame_x_loss_weight=0.3,
    frame_h_loss_weight=0.3,
    frame_bank_loss_weight=0.2,
    frame_smooth_loss_weight=0.1,
)
...
work_dir = 'output/openlane/bundlelane_r18'
